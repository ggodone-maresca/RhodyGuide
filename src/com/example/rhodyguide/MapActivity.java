...
public class MapActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dataList.add(new DrawerItem("URI Map", R.drawable.ic_action_email));
		dataList.add(new DrawerItem("My Profile", R.drawable.ic_action_good));
		dataList.add(new DrawerItem("View Class Schedule", R.drawable.ic_action_gamepad));
		dataList.add(new DrawerItem("Edit Class Schedule", R.drawable.ic_action_labels));
